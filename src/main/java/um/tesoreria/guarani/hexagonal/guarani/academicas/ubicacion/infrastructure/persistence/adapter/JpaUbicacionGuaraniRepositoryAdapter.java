package um.tesoreria.guarani.hexagonal.guarani.academicas.ubicacion.infrastructure.persistence.adapter;
...
import um.tesoreria.guarani.hexagonal.guarani.academicas.ubicacion.infrastructure.persistence.mapper.UbicacionGuaraniMapper;
import um.tesoreria.guarani.hexagonal.guarani.academicas.ubicacion.infrastructure.persistence.repository.JpaUbicacionGuaraniRepository;
...
public class JpaUbicacionGuaraniRepositoryAdapter implements UbicacionGuaraniRepository {
    ...
    @Override
    public List<UbicacionGuarani> findAllByUbicacionTipo(Integer ubicacionTipo) {
        return jpaUbicacionGuaraniRepository.findAllByUbicacionTipo(ubicacionTipo).stream()
                .map(mapper::toDomain)
                .toList();
    }
}
