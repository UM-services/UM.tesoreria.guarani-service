package um.tesoreria.guarani.hexagonal.guarani.academicas.ubicacion.infrastructure.persistence.mapper;
...
public class UbicacionGuaraniMapper {
    ...
    private final UbicacionTipoGuaraniMapper ubicacionTipoMapper;

    public UbicacionGuaraniMapper(UbicacionTipoGuaraniMapper ubicacionTipoMapper) {
        this.ubicacionTipoMapper = ubicacionTipoMapper;
    }
    ...
    public UbicacionGuaraniEntity toEntity(UbicacionGuarani domain) {
        ...
        return UbicacionGuaraniEntity.builder()
                ...
                .ubicacionTipoRel(ubicacionTipoMapper.toEntity(domain.getUbicacionTipoRel()))
    ...
    public UbicacionGuarani toDomain(UbicacionGuaraniEntity entity) {
        ...
        return UbicacionGuarani.builder()
                ...
                .ubicacionTipoRel(ubicacionTipoMapper.toDomain(entity.getUbicacionTipoRel()))
