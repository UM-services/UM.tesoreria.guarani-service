...
public interface JpaPropuestaAspiraGuaraniRepository extends JpaRepository<PropuestaAspiraGuaraniEntity, Integer> {
    List<PropuestaAspiraGuaraniEntity> findAllByPropuestaAndUbicacionAndFechaInscripcionGreaterThanEqualAndAnioAcademico(
            Integer propuesta, Integer ubicacion, LocalDate fechaDesde, BigDecimal anioAcademico);
}
